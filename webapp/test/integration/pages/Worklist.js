sap.ui.define([
		...
		"testattr/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("DEVICETYPEID"),
									name: oBindingContext.getProperty("LONGDESCRIPTION")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all TestAttrOData to be able to check for the total amount
						this.waitFor(this.createAWaitForAnEntitySet({
							entitySet: "TestAttrOData",
